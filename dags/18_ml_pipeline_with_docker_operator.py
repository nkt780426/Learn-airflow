...
with DAG(
    ...
    model_train_and_publish_task = DockerOperator(
        task_id='docker_model_train_and_publish_task_v01',
        docker_url="tcp://docker-proxy:2375",  # Use the default Docker socket
        ...
        environment={
            ...
            'MINIO_ACCESS_KEY_ID': '0UN1iXJbAbMB9k2NFejg',
            'MINIO_SECRET_ACCESS_KEY': 'nuVYYJkYBkbbARsk0Lo0hGX6feF6JJwLTFoLS2Vq',
